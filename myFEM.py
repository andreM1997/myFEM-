...
#        solver.solve_static_structural()
...
#        print("lineare FEM wird ausgeführt bla bla bla")
...
def main():
    ...
    # Controller erst erstellen ohne GUI (temporär None)
    steuerung = Controller(None)
    window = FEMGUI(steuerung)
    steuerung.gui = window
    window.show()
